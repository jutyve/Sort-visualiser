...
from cocktailshakerSort import cocktail_shaker_sort
...
def main():
    ...
    def startAlgo():
        ...
        if algomenu.get() == 'Quick Sort':
            ...
            shell_sort(data,draw,speedScale.get())
        ...
        elif algomenu.get() == 'Cocktail Shaker Sort':
            cocktail_shaker_sort(data,draw,speedScale.get())

        elif algomenu.get() == 'Radix Sort':
            radix_sort(data,draw,speedScale.get())
    ...
    algomenu = ttk.Combobox(UI_frame, textvariable=algo,
                            values=['Bubble Sort', 'Quick Sort', 'Binary Search', 'Merge Sort', 'Shell Sort', 'Selection Sort', 'Heap Sort', 'Cocktail Shaker Sort', 'Radix Sort'], width=14)
